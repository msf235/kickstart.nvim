...
vim.opt.tabstop = 2 -- display existing tabs as two spaces
vim.opt.softtabstop = 2 -- <Tab>/<BS> insert/delete two spaces
vim.opt.shiftwidth = 2 -- indent operations use two spaces
